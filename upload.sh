...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/MoodleServer.git"
#git remote add origin https://github.com/GuidoRiosCiaffaroni/MoodleServer.git
